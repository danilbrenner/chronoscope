...
## Goal
Establish a web-appropriate OneDrive sign-in flow with durable token protection and a first-run setup entry point.
...
- The Azure app registration assumptions are documented in configuration shape: **Web** app, personal Microsoft accounts only.
...
**Depends on:** Task 3.1  
**Acceptance criteria:**
- `/setup` exposes a sign-in step that redirects the user to Microsoft login instead of showing a device code.
